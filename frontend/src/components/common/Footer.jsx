...
const Footer = () => {
    ...
    const linkSections = [
        {
            title: "AUCTIONS",
            links: [
                { text: "Browse All Auctions", path: '/listings', icon: null },
                { text: "Electronics", path: '/listings?category=electronics', icon: null },
                { text: "Collectibles", path: '/listings?category=collectibles', icon: null },
                { text: "Vehicles", path: '/listings?category=vehicles', icon: null },
            ]
        },
        {
            title: "ACCOUNT",
            links: [
                { text: "My Dashboard", path: '/dashboard', icon: null },
                { text: "Create Listing", path: '/dashboard/listings/create', icon: null },
                { text: "My Bids", path: '/dashboard', icon: null },
                { text: "Notifications", path: '/notifications', icon: null },
            ]
        },
        {
            title: "CONTACT",
            links: [
                ...
                { text: "contact@goauction.com", path: 'mailto:contact@goauction.com', icon: MailIcon },
    ...
    return (
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto pt-12 pb-8 border-t">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    {/* Logo Section */}
                    <div>
                        <Link to="/" className="text-2xl font-semibold text-slate-700 mb-4 block">
                            <span className="text-green-600">go</span>Auction<span className="text-green-600 text-3xl">.</span>
                        </Link>
                ...
                <div className="border-t pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
                    <p>© {new Date().getFullYear()} GoAuction. All rights reserved.</p>
